...
from sklearn.preprocessing import StandardScaler # Zaroori for scaling input
...
def run_console_test():
    ...
    TYPE_OPTIONS = {'TRANSFER': [0.0, 0.0, 0.0, 1.0], 'PAYMENT': [0.0, 0.0, 1.0, 0.0], 'CASH_OUT': [1.0, 0.0, 0.0, 0.0]}
    ...
    while True:
        ...
        try:
            ...
            # 2. Type Selection (Transfer or Payment for clear testing)
            print("\nSelect Transaction Type:")
            print("1: TRANSFER (High Risk)")
            print("2: PAYMENT (Low Risk)")
            
            type_choice = input("Enter choice (1/2): ")
            if type_choice == '1':
                type_name = 'TRANSFER'
                type_vector = TYPE_OPTIONS['TRANSFER']
            elif type_choice == '2':
                type_name = 'PAYMENT'
                type_vector = TYPE_OPTIONS['PAYMENT']
            else:
